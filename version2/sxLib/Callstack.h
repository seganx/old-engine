...
SEGAN_LIB_API void callstack_push( const wchar* file, const sint line, const wchar* function, ... );
...
#define sx_callstack_push(function,...)	callstack_push( _CRT_WIDE(__FILE__), __LINE__, _CRT_WIDE(#function), __VA_ARGS__ )
