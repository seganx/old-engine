...
public class GestureManager : MonoBehaviour
{
    ...
    public static GestureType ActiveType { get { return Instance.activatedType; } }
    ...
    public GestureType activatedType = GestureType.Null;
    ...
    void Update()
    {
        ...
        {
            activatedType = GestureType.Null;
            touchTime = 0;
        }
