...
private:
	...
	sx::gui::TextEdit*		m_pSunDiffuse[4];		//  sun light diffuse color
	sx::gui::TextEdit*		m_pSunAmbient[4];		//  sun light ambient color
	sx::gui::ListBox*		m_pShadowLevel;			//  level of shadow quality
	sx::gui::ListBox*		m_pShadowSize;			//  size of shadow map

	sx::gui::ListBox*		m_pTextureLOD;			//  LOD of textures in the scene
	sx::gui::ListBox*		m_pShaderQuality;		//  quality of shaders in the editor
	sx::gui::ListBox*		m_reflectQuality;		//  quality of reflections in the editor

	sx::gui::ListBox*		m_fog_mode;				//	fog mode
